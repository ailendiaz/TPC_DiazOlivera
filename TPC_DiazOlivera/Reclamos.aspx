...
<asp:Content ID="Content1" ContentPlaceHolderID="Stylesheet" runat="server">
    ...
    <asp:Button ID="Pendientes" runat="server" Text="Pendientes" OnClick="btnPendientes"  class="btn btn-secondary" BorderColor="" />
    <asp:Button ID="Finalizados" runat="server" Text="Finalizados" OnClick="btnFinalizados"  class="btn btn-secondary" BorderColor="" />
